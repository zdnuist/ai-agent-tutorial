[首页](https://mungermodels.com/)/[心理学 ](https://mungermodels.com/disciplines/psych)/社会认同倾向
...
这就是社会认同倾向的力量。你以为你在[独立思考](https://mungermodels.com/models/independence)。实际上你在无意识地抄周围人的答案。
...
从进化角度来看，这种机制完全合理。在原始环境中，当你看到部落里的其他人突然开始跑，你有两个选择：停下来独立分析他们为什么跑，或者先跑了再说。选择"先跑"的个体存活率更高。在信息不完整、时间紧迫的环境中，"模仿多数人的行为"是一种非常高效的生存策略。
...
芒格还指出了一个更微妙的机制：社会认同倾向不仅影响你做什么，还影响你**觉得什么是对的** 。所罗门·阿希（Solomon Asch）在1950年代的经典从众实验中发现，当房间里的其他人（全部是演员）一致给出明显错误的答案时，大约75%的受试者至少有一次跟随了错误答案。更令人不安的是，事后访谈显示，相当一部分受试者真的觉得自己看到了和多数人一样的东西——社会认同不仅改变了他们的回答，还改变了他们的感知。
...
后世广为流传一句据说出自牛顿之口的苦涩话——"我能计算天体的运动，却无法计算人类的疯狂。"——但芒格会指出：牛顿的问题不是"无法计算疯狂"——他的问题是他自己就是疯狂的一部分。他不是被某个复杂的金融骗局欺骗了，他是被社会认同倾向击败了。当周围每个人都在赚钱的时候，"不参与"产生了一种心理上的被剥夺感——别人都在赚钱而我没有。这种感觉比任何理性分析都更有驱动力。
...
泡沫从来不是一个人的疯狂。泡沫是社会认同倾向的Lollapalooza效应：每个人的买入行为都在强化其他所有人买入的理由。价格上涨 → 更多人买入 → 价格继续上涨 → 更更多人买入。
...
最终，谢皮科在一次卧底行动中被"意外"射伤——很多人怀疑这是同事故意不提供支援的结果。他活了下来，最终促成了纳普委员会对纽约警察腐败的大规模调查。但他也为此付出了巨大的个人代价。
...
安然公司（Enron）崩溃前，内部有大量员工知道数字有问题，但几乎没有人公开质疑。不是因为他们都是坏人。是因为社会认同倾向让"和大家一样沉默"变成了心理上最安全的选项。

§ 04

## 被忽视的边界与反直觉

**社会认同并非总是错误的。**  在很多场景中，参考其他人的行为是完全理性的。如果你走进一家从未去过的餐厅，看到里面坐满了人，而隔壁那家空空如也——选择人多的那家不是"盲目从众"，而是合理地利用了群体的信息。芒格警告的不是"永远不要参考别人的做法"，而是"不要在关键决策中让社会认同替代独立思考"。

**困惑+压力=最大脆弱性。**  在日常低压环境中，你对社会认同有一定的抵抗力。但当你同时感到困惑（不确定答案是什么）和压力（感到威胁或紧迫性）时，独立思考的能力会急剧下降。这就是为什么市场恐慌时的抛售如此猛烈——不仅仅是人们在"跟风卖出"，而是恐慌本身创造了最适合社会认同接管的心理条件。操纵者深谙此道：制造紧迫感和不确定性是所有社会操控技术的起点。

**与[避免不一致性倾向](https://mungermodels.com/models/inconsistency-avoidance-tendency)的叠加效应。**  一旦你因为社会认同而加入了某个群体的行为模式，避免不一致性倾向就会锁定你在这个模式中。你不仅开始跟着做，你还会开始相信这么做是对的，然后拒绝接受任何与这个信念矛盾的信息。社会认同是入口，一致性偏见是锁。两者配合，可以让整个组织在错误的路径上越走越远。
...
**决策触发器二：当你感到"说出不同意见"很困难的时候。**  这种困难感本身就是社会认同在运作的信号。如果你在会议上有一个反对意见但选择沉默，问问自己：你沉默是因为你的反对意见不够好，还是因为房间里的共识让你觉得开口的成本太高？芒格建议在重要决策中采用"先独立后讨论"的程序：每个人先把自己的判断写下来，然后再讨论。

**决策触发器三：当你处于困惑+压力的双重状态时。**  这是你最脆弱的时刻。在这种状态下，你对社会信号的依赖会大幅上升。芒格的建议是：在这种时刻，刻意放慢决策速度。不要在恐慌中卖出，不要在狂热中买入。等困惑和压力消退到可控水平后再做决定。
...
- [**避免怀疑倾向**](https://mungermodels.com/models/doubt-avoidance-tendency) ：不确定性越高，社会认同的驱动力越强

- [**避免不一致性倾向**](https://mungermodels.com/models/inconsistency-avoidance-tendency) ：社会认同是入口，一致性偏见是锁

- [**被剥夺超级反应倾向**](https://mungermodels.com/models/deprival-superreaction-tendency) ：别人在赚钱而你没有参与，会触发被剥夺感

- [**艳羡与妒忌倾向**](https://mungermodels.com/models/envy-jealousy-tendency) ：看到别人获得成功，嫉妒会放大社会认同信号

- [**Lollapalooza倾向**](https://mungermodels.com/models/lollapalooza-tendency) ：社会认同+压力+被剥夺感+一致性偏见的叠加
