[首页](https://mungermodels.com/)/[心理学 ](https://mungermodels.com/disciplines/psych)/被剥夺超级反应倾向
...
但数据讲了一个完全不同的故事。**投资者卖出赚钱股票的概率比卖出亏钱股票的概率高出约50%。**  奥丁把这种现象叫做"处置效应"（Disposition Effect）。更残酷的是后续发现：被卖掉的赢家在接下来一年的表现，系统性地优于被保留的输家。换句话说，投资者在做与正确操作恰好相反的事——他们在割花浇草。
...
**误区二：与[自视过高的倾向](https://mungermodels.com/models/excessive-self-regard-tendency)中禀赋效应的关系。**  禀赋效应（高估你拥有的东西的价值）和被剥夺超级反应（对失去已有东西的过度痛苦反应）是同一枚硬币的两面。芒格把禀赋效应放在自视过高倾向下面讨论，但它与被剥夺超级反应紧密交织。你高估你拥有的东西的价值（禀赋效应），因此失去它时痛苦更大（被剥夺超级反应），而这种超比例的痛苦又反过来强化了你对它价值的高估。两个倾向互相喂养。

**误区三："[沉没成本谬误](https://mungermodels.com/models/sunk-cost-fallacy)不就是这个吗？"**  有关系但不完全等同。沉没成本谬误是被剥夺超级反应的一种**表现形式** ：你已经投入了资源（时间、金钱、情感），放弃意味着这些投入"白费了"，被剥夺超级反应让你无法接受这种"白费"的痛苦，所以你继续投入。但被剥夺超级反应的适用范围比沉没成本更广——它也适用于"差一点得到"和"习惯了的基准"这些不涉及先前投入的场景。

**与[对比错误反应倾向](https://mungermodels.com/models/contrast-misreaction-tendency)的互动。**  被剥夺超级反应可以被对比效应放大或缩小。如果你的损失是在一个缓慢、渐进的过程中发生的（温水煮青蛙），对比效应会让每一步的"被剥夺感"变得不明显，从而延迟了你的反应——等你终于反应过来时，累积损失已经很大了。柯达的衰退就是这种模式：胶卷市场份额不是一夜之间消失的，而是年复一年缓慢下降，每一年的下降都"不值得恐慌"，但二十年后回头看，一个帝国已经灰飞烟灭。
...
- [**自视过高的倾向**](https://mungermodels.com/models/excessive-self-regard-tendency) ：禀赋效应是自视过高的一个分支——你不仅高估自己，还高估一切"你的"东西，放大了被剥夺时的痛苦

- [**奖励和惩罚超级反应倾向**](https://mungermodels.com/models/reward-and-punishment-superresponse-tendency) ：失去（惩罚）的超级反应是激励不对称性的直接表现

- [**过度乐观倾向**](https://mungermodels.com/models/overoptimism-tendency) ：过度乐观设定了不切实际的预期基准线，当现实低于这个基准时，被剥夺反应被放大

- [**避免不一致性倾向**](https://mungermodels.com/models/inconsistency-avoidance-tendency) ：承认损失意味着承认先前判断有误，一致性倾向让人拒绝这种承认

- [**对比错误反应倾向**](https://mungermodels.com/models/contrast-misreaction-tendency) ：渐进式损失（温水煮青蛙）可以绕过被剥夺超级反应的触发阈值，造成更大的累积伤害

- [**社会认同倾向**](https://mungermodels.com/models/social-proof-tendency) ：当周围的人都在"死扛"亏损时，你也更难做出止损决策

- [**Lollapalooza倾向**](https://mungermodels.com/models/lollapalooza-tendency) ：被剥夺反应+沉没成本+避免不一致性的叠加，可以让人在灾难性的路径上越走越远
