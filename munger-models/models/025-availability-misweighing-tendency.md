[首页](https://mungermodels.com/)/[心理学 ](https://mungermodels.com/disciplines/psych)/错误衡量易得性倾向
...
芒格没有用医学案例，但他讲了一个在投资领域同样说明问题的例子。他观察到，投资者对公司的评估严重受到信息呈现方式的影响。同样一家公司，如果它频繁出现在财经媒体上——不管是因为好消息还是坏消息——投资者对它的"认知权重"就会远超那些默默赚钱但从不上头条的公司。这导致了一个系统性的后果：被广泛报道的公司往往被过度交易、过度定价（高估或低估），而那些"低可得性"的优质公司更有可能被低估。
...
芒格自己在投资决策中使用检查清单。在考虑一笔投资时，他不是凭"感觉上这是一家好公司"来做判断——他系统性地检查一系列预先设定的条件：管理层的诚信度、业务的竞争护城河、资本配置的质量、价格相对于[内在价值](https://mungermodels.com/models/intrinsic-value)的折扣。这个清单确保了那些"不容易想到"但至关重要的因素不会因为某个高可得性的利好消息而被忽略。
...
芒格还有第二味药，同样重要：**[跨学科思维](https://mungermodels.com/models/multidisciplinary-approach)。**  如果你只在一个学科的框架内思考，你能想到的解释和方案就局限于那个学科提供的工具箱——而那个工具箱里最容易拿到的工具会被过度使用。用芒格的话说："对于一个只有锤子的人来说，每个问题看起来都像钉子。"跨学科思维的功能之一，就是拓宽你的"可得性池"——当你能同时从心理学、经济学、生物学、历史学的角度看一个问题时，你被任何单一框架的易得性局限所误导的概率就大幅降低了。
...
芒格的[检查清单方法](https://mungermodels.com/models/checklist-method)论的价值恰恰在这里：它不依赖你对自己偏差的觉察（因为你通常觉察不到），而是建立一个外部系统来系统性地弥补你内部系统的缺陷。这不是谦虚，这是工程。
...
- [**受简单联想影响的倾向**](https://mungermodels.com/models/influence-from-mere-association-tendency) ：易得性偏差是联想机制的产物——容易联想到的信息被赋予更高的权重

- [**社会认同倾向**](https://mungermodels.com/models/social-proof-tendency) ：当周围的人都在讨论某件事时，那件事在你的记忆中变得更易得，进一步强化错误判断

- [**过度乐观倾向**](https://mungermodels.com/models/overoptimism-tendency) ：在牛市中，成功案例的高可得性让人高估投资成功的概率

- [**被剥夺超级反应倾向**](https://mungermodels.com/models/deprival-superreaction-tendency) ：损失的生动记忆比同等收益的记忆更易得，导致对风险的不对称评估

- [**压力影响倾向**](https://mungermodels.com/models/stress-influence-tendency) ：在高压状态下，情绪化记忆的易得性进一步增强，判断质量急剧下降

- [**奖励和惩罚超级反应倾向**](https://mungermodels.com/models/reward-and-punishment-superresponse-tendency) ：激励结构决定了哪些信息被重复曝光，从而改变其易得性
...
[ ← 下一篇 沉没成本谬误](https://mungermodels.com/models/sunk-cost-fallacy) [ 下一篇 → 艳羡与妒忌倾向](https://mungermodels.com/models/envy-jealousy-tendency)
