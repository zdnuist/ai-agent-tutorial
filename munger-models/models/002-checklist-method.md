...
> **学科**：元认知与思维方法论  
> **重要度**：★★★★★  
> **来源**：[mungermodels.com](https://mungermodels.com/models/checklist-method/)
...
**第二层：评估性清单（Assessment Criteria）。** 通过了排除性筛选的少数机会，需要更深入的多维度评估。这包括：竞争优势的来源和可持续性（护城河是什么？能持续多久？）、管理层的资本配置能力、行业的长期竞争动态、估值是否提供了足够的安全边际、以及——这是双轨分析的第二轨道——自己在这个特定决策中可能受到哪些心理偏差的影响。
...
- [双轨分析](019-two-track-analysis.md) — 检查清单是双轨分析第二轨道（心理偏差排查）的最佳执行工具
- [Lollapalooza倾向](028-lollapalooza-tendency.md) — 清单帮助识别多种心理力量叠加的危险情境
- [铁锤人倾向](005-man-with-a-hammer-syndrome.md) — 清单强制你检查多个维度，对抗只用一个模型分析一切的倾向
- [避免意识形态偏见](003-avoiding-ideology.md) — 清单提供客观的检查框架，帮助你避免被意识形态过滤信息
- [能力圈](183-circle-of-competence.md) — 清单的第一项排除条件往往是"这是否在我的能力圈内"
- [安全边际](182-margin-of-safety.md) — 清单本身就是一种认知上的安全边际——它在你犯错前拦住你
- [自视过高的倾向](030-excessive-self-regard-tendency.md) — 抵触使用清单本身就是自视过高倾向的表现
- [五何原则](021-five-ws-principle.md) — 五何原则（何人、何事、何时、何地、为何）提供了检查清单的基本维度框架
